    ...
    <>
      ...
      <div className="our-story-container">
        <div className="hero-section">
          ...
          <p className="subtitle text-[1.3rem] text-[#6c3483] italic">
        ...
        <div className="story-content">
          <p>
            ...
            . Từ những ngày đầu chỉ có vài dụng cụ thô sơ và một nhóm nhỏ những
            người thợ mộc đam mê, chúng tôi đã dần dần tạo nên một hành trình
            đầy ý nghĩa.
          </p>
          ...
          <p>
            ...
            chỉ đơn thuần là vật dụng –{" "}
            <em className="text-blue-500">
              nó là nơi gắn kết yêu thương, là điểm tựa trong những bữa cơm sum
              vầy, là góc nhỏ yên tĩnh để ta tìm về sau một ngày dài
            </em>
            .
          </p>
          ...
          <p>
            ...
            vững. Mỗi sản phẩm ra đời đều mang trong mình câu chuyện – câu
            chuyện về bàn tay cần mẫn, về giọt mồ hôi rơi, và cả niềm tự hào của
            những người thợ.
          </p>
          ...
          <p>
            ...
            của mình không chỉ là làm ra đồ nội thất, mà là{" "}
            <strong className="text-orange-600">
              tạo ra ký ức, nâng niu từng khoảnh khắc trong mái ấm
            </strong>
            .
          </p>
          ...
          <p>
            ...
            huyết của người thợ. Chúng tôi cam kết mang đến không chỉ chất lượng
